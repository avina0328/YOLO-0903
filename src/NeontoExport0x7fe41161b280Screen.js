...
export default class NeontoExport0x7fe41161b280Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen NeontoExport0x7fe41161b280Screen" style={baseStyle}>
